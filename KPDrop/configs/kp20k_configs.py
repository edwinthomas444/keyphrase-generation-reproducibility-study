...
class optimizer_config:
    def __init__(self):
        ...
        self.batch_size = 4 # changed from 64
        self.train_batch_size = 4 # changed from 64
        self.dev_batch_size = 32 # changed from 12
        self.truncate = False
        self.bucket_size_factor = 1
        self.DataParallel = True # set True for Training and False for evaluation
        self.custom_betas = False
        self.weight_decay = 0.0
        self.lr = 1e-3
        self.epochs = 5 # changed for testing from 20
...
class base_config(optimizer_config):
    def __init__(self):
        ...
        self.embd_dim = 100 #100
        self.encoder_hidden_size = 150 # 150
        self.decoder_hidden_size = 300 # 300
        self.encoder_layers = 1
        self.pointer = True # pointer is for copy attention for oov type cases
        self.kpdrop = 0.0
...
class TransformerSeq2Seq_config(base_config):
    def __init__(self):
        ...
        self.embd_dim = 768 # 512
        self.hidden_size = 768 # 512
        self.num_layers = 12 # 6
        self.ff_dim = 3072 # 2048
        self.head_dim = 64 # 64
        self.heads = 12 # 8
        ...
        self.train_batch_size = 32 # changing to double was 32
        self.batch_size = 32
...
class TransformerSeq2Set_config(TransformerSeq2Seq_config):
    def __init__(self):
        ...
        self.one2set = True
        self.one2one = False
        self.max_decoder_len = 6 # chagned from 6
        self.max_kp_num = 20 # changed from 20
        self.assign_steps = 6 # changed from 2
